...
To create the data model on mindsphere the following insturctions were followed: 

https://documentation.mindsphere.io/MindSphere/howto/howto-send-data-from-mqtt-agent.html

Here is a list of stepts taken to get our data into mindsphere:
...
3. Publish to topic: tc/camexia/camexia_dash7_gateway_1/o/amo_v3/i
   ...
   ```
4. Publish data to timeseries: tc/camexia/camexia_dash7_gateway_1/o/mc_v3/ts
